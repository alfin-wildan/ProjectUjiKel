                ...
                <div className="m-5 pb-10 pt-10">
                    <div className="flex justify-between">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <button className="px-4 py-2 bg-orange-500 text-white shadow-md border-sky-500 rounded-lg flex items-center">
                                <Link to="/user/trash">
                            ...
                            <tbody>
                                {user.map((user, index) => (
                                    <tr key={user.id} className="border-b dark:border-neutral-500">
                                        ...
                                        <td className="text-white px-6 py-4">{user.id}</td>
                                        <td className="text-white px-6 py-4">{user.username}</td>
                                        <td className="text-white px-6 py-4">{user.email}</td>
                                        <td className="text-white px-6 py-4">{user.password}</td>
