...
import { faPlus } from "@fortawesome/free-solid-svg-icons"; // Make sure to import the specific icon
                ...
                <div className="m-5 pb-10 pt-10">
                    <div className="flex justify-between">
                        ...
                        <div className="flex">
                            ...
                            <button className="px-4 py-2 bg-orange-500 text-white shadow-md border-sky-500 rounded-lg">
                                <Link to="/stuff/trash">
